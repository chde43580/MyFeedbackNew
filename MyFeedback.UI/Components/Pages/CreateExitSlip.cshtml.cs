...
namespace MyFeedback.UI.Pages
{
    ...
    public class ExitSlipModel : PageModel
    {
        ...
        [BindProperty]
        public CreateExitSlipRequestDto createExitSlipRequestDto { get; set; } // Binder s� brugerens tekst kan trackes og sendes videre til API'en
